...
var _user$project$Guess$revealAndIncrementer = function (_p3) {
	var _p4 = _p3;
	var _p6 = _p4.word;
		...
		switch (_p12.ctor) {
			...
			case 'Reveal':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						revealedWord: _user$project$Guess$revealAndIncrementer(model)
					});
			case 'Check':
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Guess$showInitialListWord = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	A2(
		_elm_lang$core$List$map,
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Give a hint'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Submite answer'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _user$project$Guess$showInitialListWord,
							_1: {ctor: '[]'}
						}
					}
				}
...
var Elm = {};
Elm['Guess'] = Elm['Guess'] || {};
if (typeof _user$project$Guess$main !== 'undefined') {
    _user$project$Guess$main(Elm['Guess'], 'Guess', undefined);
}
